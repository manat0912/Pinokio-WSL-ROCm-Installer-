...
set "WSLENV=ROCM_USE_WSL/u:HSA_OVERRIDE_GFX_VERSION/u:HSA_ENABLE_SDMA/u:HSA_FORCE_FINE_GRAIN_PCIE/u:GPU_MAX_HEAP_SIZE/u:GPU_MAX_ALLOC_PERCENT/u:GPU_SINGLE_ALLOC_PERCENT/u:ELECTRON_DISABLE_GPU_SANDBOX/u:ELECTRON_FORCE_WINDOW_MENU_BAR/u:MESA_NO_ERROR/u:vblank_mode/u"
