...
set "AMDGPU_TARGETS=gfx1200"
set "PYTORCH_ROCM_ARCH=gfx1200"
set "ROCM_FLASH_ATTN_USE_CK=0"
set "FLASH_ATTENTION_TRITON_AMD_ENABLE=TRUE"
set "FLASH_ATTN_TRITON=1"
